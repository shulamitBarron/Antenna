...
{
    internal class PointConverters
    {
        ...
        //SingleTon property
        private static PointConverters instance;
        public static PointConverters Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new PointConverters();
                }
                return instance;
            }
            set
        ...
        //=================================================
        public  void wgs842itm(double lat, double lon, out int N, out int E)
        {
